...
async function handlePaymentSubmit(e) {
    ...
    const { customer_id } = await fetch("create_customer.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        // body: JSON.stringify({ payment_intent_id: payment_intent_id, fullname: fullname, email: email, mobile: mobile, address: address, amount: amount })
        body: JSON.stringify({ payment_intent_id: payment_intent_id, fullname: fullname, email: email, amount: amount })
    }).then((r) => r.json());
