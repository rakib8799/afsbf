...
<div class="page-top" style="background-image: url({{ isset($global_banner->join_volunteer) ? asset('uploads/photo/'.$global_banner->join_volunteer) : asset('uploads/photo/'.$global_setting_data->banner) }})">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
