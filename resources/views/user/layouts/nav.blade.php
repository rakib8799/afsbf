        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                @if(Auth::guard('web')->user()->photo != null)
                    <img src="{{ asset('storage/uploads/photo/'.Auth::guard('web')->user()->photo) }}" alt="" class="rounded-circle-custom">
                @else
                    <img src="{{ asset('uploads/default.png') }}" alt="" class="rounded-circle-custom">
                @endif
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ route('user.profile.edit') }}"><i class="far fa-user"></i> Edit Profile</a></li>
                <li>
